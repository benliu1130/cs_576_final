...
public class MyEncoder420 {
	...
	public static void main(String[] args) {
		...
		for(int index = 0; index <= numberOfFrames - 1; index++){
			...
			quantizedData[index] = LayeredImageCodec.encoder420(img, width, height, n1, n2, layerOfImg8);
		}
		time = System.currentTimeMillis() - time;
		...
		try {
			writeToFile(outputFile, width, height, n1, n2, vectorsOfVideo, layerOfVideo16, quantizedData, S420);
		} catch (IOException e) {
		...
		window.setTitle("Display Window: MyEncoder420");
