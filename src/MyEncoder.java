...
public class MyEncoder {
	...
	public static void main(String[] args) {
		...
		for(int index = 0; index <= numberOfFrames - 1; index++){
			...
			quantizedData[index] = LayeredImageCodec.encoder(img, width, height, n1, n2, layerOfImg8);
		}
		time = System.currentTimeMillis() - time;
		...
		try {
			writeToFile(outputFile, width, height, n1, n2, vectorsOfVideo, layerOfVideo16, quantizedData, DEFAULT);
		} catch (IOException e) {
		...
		window.setTitle("Display Window: MyEncoder");
